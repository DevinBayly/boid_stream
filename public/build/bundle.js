...
var app = (function () {
    ...
    /* src/canvas.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file, 66, 0, 1638);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(0, canvas.width = 5000, canvas);
    		...
    		//
    		let a = [
    			...Array(20).fill(0).map((e, i) => i > 10 ? 1 : 0),
    			...Array(20).fill(0).map((e, i) => i < 10 ? 1 : 0)
    		];
    		...
    		let constructCont = (a, color) => {
    			...
    			let vmax = Math.max(...values) + 0.1; // for margin
    			console.log(vmax);
    			ctx.fillStyle = color;

    			values.map((e, i) => {
    				ctx.fillRect(i / values.length * canvas.width, canvas.height - (e - 0.1) / vmax * canvas.height - 10, 5, 5);
    			});
    		};
    	...
    	$$self.$capture_state = () => ({ canvas, ctx, onMount });
    ...
    /* src/assignment.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (img.src !== (img_src_value = "http://localhost:8001/image")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 29, 0, 334);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
